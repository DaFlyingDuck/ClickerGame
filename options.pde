void options() {
  ...
  //Indicator 
  if (imgChoice == 1) {
    image(doge, 50, 325, diameter, diameter);
  } else if (imgChoice == 2) {
    image(cat, 50, 325, diameter, diameter);
  } else {
    image(crying, 50, 325, diameter, diameter);
  }
...
void optionsClicks() {
  ...
  } else if (dist(mouseX, mouseY, slider.x, slider.y) <= 25 && mouseY >= 350 && mouseY <= 550) {
    slider.y = mouseY;
  }
...
void optionsDragged() {
  ...
  if (dist(mouseX, mouseY, slider.x, slider.y) <= 25 && mouseY >= 350 && mouseY <= 550) {
    slider.y = mouseY;
  }
